...
<head>
    <title>Code coverage report for createRequireContext.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="index.html">All files</a> createRequireContext.ts</h1>
        <div class='clearfix'>
...
export function createRequireContext(
  dirname: string,
  {
    require = <span class="branch-0 cbranch-no" title="branch not covered" >globalRequire,</span>
    resolve = <span class="branch-0 cbranch-no" title="branch not covered" >globalRequire.resolve.bind(globalRequire),</span>
  }: CreateRequireContextOptions = <span class="branch-0 cbranch-no" title="branch not covered" >{}</span>
): WebpackRequireContextFactory {
  function requireContext(
    directory: string,
    recursive = <span class="branch-0 cbranch-no" title="branch not covered" >true,</span>
    regExp = <span class="branch-0 cbranch-no" title="branch not covered" >/.*/</span>
  ): WebpackRequireContext {
    console.warn('Usage of require.context is deprecated.')
&nbsp;
    try {
      const basedir = path.resolve(dirname, directory)
&nbsp;
      const keys = klaw(basedir, {
        depthLimit: recursive ? 30 : <span class="branch-1 cbranch-no" title="branch not covered" >0,</span>
      })
        ...
        .map((filename) =&gt; (filename.startsWith('.') ? <span class="branch-0 cbranch-no" title="branch not covered" >filename </span>: `./${filename}`))
&nbsp;
...
<span class="cstat-no" title="statement not covered" >      contextErr.message = `Error running require.context():\n\n${contextErr.message}`</span>
<span class="cstat-no" title="statement not covered" >      throw contextErr</span>
    }
  }
&nbsp;
...
&nbsp;</pre></td></tr></table></pre>
            ...
            <div class='footer quiet pad2 space-top1 center small'>
                ...
                at Mon Nov 01 2021 18:38:41 GMT-0400 (Eastern Daylight Time)
            </div>
        </div>
